        ...
        <div className="grid gap-8 md:gap-12 lg:grid-cols-4">
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-gray-400 mb-4">
              Dedicated to advancing cybersecurity awareness and providing essential resources to protect digital assets.
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 lg:col-span-3">
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Network Security</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Cloud Protection</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Endpoint Security</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Identity Management</a></li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Vulnerability Database</a></li>
