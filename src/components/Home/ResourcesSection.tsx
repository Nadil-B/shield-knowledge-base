...
import { ArrowRight, BookOpen, FileText, PenTool, Play, Shield, CheckCircle2, AlertTriangle, Download } from "lucide-react";
import {
  Card,
  CardContent,
  CardDescription,
      ...
      <div className="container px-4 sm:px-6">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-12">
          ...
          <ResourceCard
            ...
            description="Interactive assessments for security knowledge"
        ...
        <div className="bg-gradient-to-r from-cyber-blue to-cyber-teal rounded-lg p-6 md:p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-white/90 max-w-2xl mx-auto">
              Test your cybersecurity knowledge with our interactive assessments. 
              Get personalised recommendations and identify areas for improvement.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            <div className="bg-white/10 rounded-lg p-4 text-center">
              ...
              <p className="text-white/80 text-sm">Assess your understanding of security concepts</p>
            </div>
            
            <div className="bg-white/10 rounded-lg p-4 text-center">
              <AlertTriangle className="h-6 w-6 text-white mx-auto mb-2" />
              <h4 className="font-medium text-white mb-1">Threat Analysis</h4>
              <p className="text-white/80 text-sm">Learn to identify potential security threats</p>
            </div>
            
            <div className="bg-white/10 rounded-lg p-4 text-center">
              <Download className="h-6 w-6 text-white mx-auto mb-2" />
              <h4 className="font-medium text-white mb-1">Learning Path</h4>
              <p className="text-white/80 text-sm">Get customised learning recommendations</p>
            </div>
          </div>
